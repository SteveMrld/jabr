...
export const PROJECTS: Project[] = [
  { id: 1, title: "Mon Petit Livre Anti-Stress", author: "Steve Moradel", illustrator: "Allison Moradel", genre: "Jeunesse", collection: "Étincelles", isbn: "978-2-488647-00-7", price: "18,90€", score: 7, maxScore: 7, status: "published", pages: 136, cover: "🌅", diag: { ean: true, prix: true, isbn_txt: true, texte4e: true, typo: true, dos: true, logo: true }, corrections: [] },
